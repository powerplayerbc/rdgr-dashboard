    ...
    if (!revealed) {
        if (!fcState.mulTimerStarted) {
            ...
            const messages = [
                ...
                "Nice thinking!",
                "You are becoming a math master!",
                ...
                "Super sharp thinking!",
                "You are a problem-solving champion!",
                "Math practice is making you powerful!",
                "You are crushing these flashcards!",
